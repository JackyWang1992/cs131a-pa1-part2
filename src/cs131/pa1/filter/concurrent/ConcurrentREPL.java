...
public class ConcurrentREPL {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (command.equals("exit")) {
                ...
                for (int i = 0; i < bgCmds.length; i++){
                    ConcurrentFilter filterlist = ConcurrentCommandBuilder.createFiltersFromCommand(bgCmds[i]);
    ...
    public static boolean kill(String command) {
        ...
        ConcurrentFilter curr = bgFilters.get(kindex);
        while (curr != null) {
